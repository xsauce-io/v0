      ...
      <div className="flex flex-col flex-1 ">
        <div className="flex flex-row bg-white border-2 border-[#0C1615] rounded-[40px] mb-3">
          <button
            ...
            className={
              !isStaked
                ? 'flex flex-row justify-center items-center space-x-1 tablet:space-x-2   w-1/2  font-medium text-[10px]  tablet:text-[16px] py-3 text-black bg-white  border-r-0 border-[#0C1615] rounded-tl-[40px] rounded-bl-[40px]  '
                : 'flex flex-row justify-center items-center space-x-1 tablet:space-x-2  w-[55%] font-medium text-[10px]  tablet:text-[16px] py-3 text-white  bg-[#0C1615] rounded-[40px]'
            }
          ...
          <button
            ...
            className={
              isStaked
                ? 'flex flex-row justify-center items-center space-x-1 tablet:space-x-2 w-1/2 font-medium text-[10px] tablet:text-[16px]  py-3 text-black bg-white  border-l-0 border-[#0C1615] rounded-tr-[40px] rounded-br-[40px] '
                : 'flex flex-row justify-center items-center space-x-1 tablet:space-x-2 w-[55%] font-medium text-[10px] tablet:text-[16px] py-3 text-white  bg-[#0C1615] rounded-[40px] '
            }
        ...
        <div className=" flex flex-row  bg-white items-center py-4 px-6 text-left w-[100%] border-[1px] border-black rounded-[80px]  focus:outline-2 focus:outline-offset-2 hover:outline-1">
