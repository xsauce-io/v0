      ...
      <div className="flex flex-col flex-1 ">
        <div className="flex flex-row bg-white border-2 border-[#0C1615] rounded-[40px] mb-3">
          <button
            ...
            className={
              !isStaked
                ? 'flex flex-row justify-center items-center space-x-2  tablet:py-4  w-1/2  font-medium text-xs   tablet:text-[16px]  text-black bg-white  border-r-0 border-[#0C1615] rounded-tl-[40px] rounded-bl-[40px]  '
                : 'flex flex-row justify-center items-center space-x-2 tablet:py-4 w-[55%] font-medium text-xs   tablet:text-[16px]  text-white  bg-[#0C1615] rounded-[40px]'
            }
