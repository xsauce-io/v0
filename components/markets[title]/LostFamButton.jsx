...
export const LostFamButton = () => {
    ...
    return (
        <div className="px-3">
            <div className="w-fit px-1 group relative hover:underline font-SG">
                <button onClick={() => setOpen((previousState)=> !previousState)} className='font-SG  underline'>I am lost fam</button>
                {open ?
