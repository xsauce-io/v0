                ...
                <div className='bg-white items-center text-left border-b-[1px] p-4   space-y-4 border-[#0C1615] w-full '>
                    ...
                    <div class="bg-white items-center p-3  px-5 text-left w-[100%] border-[1px] rounded-3xl border-[#0C1615]  dropdown dropdown-end  ">
                        ...
                        <ul tabindex="0" class="menu dropdown-content p-2 shadow bg-[#EFF1F3] rounded-box w-[25%] mt-4    ">
                            <li className="hover:bg-[#ACFF00] rounded-box"><a onClick={() => { setIsYes(true) }} className="flex justify-right">Yes</a></li>
                            <li className="hover:bg-[#ACFF00] rounded-box"><a onClick={() => { setIsYes(false) }}>No</a></li>
                        </ul>
                    </div>
                    ...
                    <div className='bg-white items-center p-3  px-5 text-left w-[100%] border-[1px] rounded-3xl border-[#0C1615] flex' >
                        ...
                        <div class="dropdown dropdown-end ">
                            ...
                            <ul tabindex="0" className="menu dropdown-content p-2 shadow bg-[#EFF1F3] rounded-box mt-4">
                                <li className="hover:bg-[#ACFF00] rounded-box"  ><a onClick={() => { setIsBuy(true) }}>Buy</a></li>
                                <li className="hover:bg-[#ACFF00] rounded-box"><a onClick={() => { setIsBuy(false) }}>Sell</a></li>
                            </ul>
                        </div>
