 ...
 laptop:h-[420px] w-[280px] items-start text-left">
      ...
      <div className="flex flex-row items-center laptop:flex-col laptop:space-y-2 laptop:justify-center">
        ...
        {cardObject.image?.original === '' || cardObject.image?.original === 'https://image.goat.com/placeholders/product_templates/original/missing.png' ?
          <React.Fragment>
                      <div className="w-full h-[125px] bg-white flex flex-col justify-center items-center border-black border-[1px] rounded-tl-md rounded-tr-md">
            <img className='mobile:h-[30px] px-4 laptop:w-[50%] laptop:h-[75%] px-4' src='/hurache.svg'/>
            </div>
        ...
        <div className='flex flex-row items-center border-[#30403F] border-[1px] rounded-[40px]  w-[80%] h-[40%] py-2 px-3 space-x-2 items-center'>
          ...
          <p className={favored == true ? "bg-[#ACFF00] text-black  rounded-[40px]  flex flex-row justify-center laptop:text-[10px] py-1 border-[1px] border-[#30403F] h-full w-full": "text-white rounded-[40px] flex flex-row justify-center laptop:text-[10px] border-[1px] py-1 border-[#30403F] h-full w-full"} >No - {No}</p>

        <p className={favored == false ? "bg-[#ACFF00] text-black  rounded-[40px]  flex flex-row justify-center laptop:text-[10px] py-1 border-[1px] border-[#30403F] h-full w-full": "text-white rounded-[40px] flex flex-row justify-center laptop:text-[10px] border-[1px] py-1 border-[#30403F] h-full w-full"}>Yes - {Yes}</p>
        </div>
