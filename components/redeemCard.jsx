          ...
          <div className="flex items-left flex-col laptop:space-y-3 laptop:justify-center  w-full h-full">
            ...
            {cardObject.image?.original === '' || cardObject.image?.original === 'https://image.goat.com/placeholders/product_templates/original/missing.png' ?
              ...
              <div className="w-full h-1/4 bg-white justify-center items-center border-black border-[1px] rounded-tl-md rounded-tr-md">
                <img className='object-cover w-[40%] m-auto laptop:h-[100%] scale-125' src='/hurache.svg' />
              </div>
              :
              ...
              <div className="w-full h-1/4 bg-white justify-center items-center border-black border-[1px] rounded-tl-md rounded-tr-md">
                ...
                <img className='object-cover w-[40%] m-auto laptop:h-[100%] scale-150' src={cardObject.image?.original}></img>
              </div>
                ...
                <div className="flex flex-col w-full py-4 space-y-3 font-light">
                  ...
                  <div className="space-y-3">
                    <div className='flex flex-row items-center border-[#30403F] border-[1px] rounded-[40px]  w-[80%] h-[50%] py-2 px-4 space-x-2 items-center font-inter'>
                      ...
                      <p className={favored == true ? "bg-[#ACFF00] text-black  text-[14px] font-normal rounded-[40px]  flex flex-row justify-center mobile:text-xs tablet:text-sm  py-1  border-[1px] border-[#30403F] h-full w-full" : "text-white  mobile:text-xs laptop:text-sm font-normal  rounded-[40px] flex flex-row justify-center  border-[1px] py-1 border-[#30403F] h-full w-full"} >No - {No} %</p>

                      <p className={favored == false ? "bg-[#ACFF00] text-black  text-[14px] font-normal  rounded-[40px]  flex flex-row justify-center  mobile:text-xs tablet:text-sm  py-1 border-[1px] border-[#30403F] h-full w-full" : "text-white mobile:text-xs laptop:text-sm font-normal  rounded-[40px] flex flex-row justify-center  border-[1px] py-1 border-[#30403F] h-full w-full"}>Yes - {Yes} %</p>
                    </div>
                    <Link href={cardObjectHref}>

                      <button className='flex flex-row items-center text-white text-[14px]  border-[#30403F] border-[1px] rounded-[40px]  w-[80%] h-[30%] py-2 px-4 items-center hover:bg-[#ACFF00] hover:text-black mobile:text-xs laptop:text-sm'> <p> Place a bet on this sneaker</p> <img className="ml-3 text-white" src="/slimRightArrowWhite.svg" /></button>
                    </Link>
                  </div>
