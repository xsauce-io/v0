	...
	return (
		<div className="block relative pb-10">
			<div className="flex overflow-auto scrollbar-hide">
				...
				<button className="w-[40px] opacity-50 mobile:h-[250px] tablet:h-[300px] bg-gradient-to-r from-[#000000] to-white absolute top-0 left-0"></button>
				<button className="w-[40px] opacity-50 mobile:h-[250px] tablet:h-[300px] bg-gradient-to-l from-[#000000] to-white  z-10 absolute top-0 right-0 "></button>
			</div>
		</div>
	);
};
