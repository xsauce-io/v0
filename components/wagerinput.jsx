...
<ToggleButtonGroup
 ...
 color= { isYes === true ? "primary" : 'secondary' }
  sx={{backgroundColor:'white', width:'75%', boxShadow:'0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1)' }}
  value={alignment}
  exclusive
  onChange={handleChange}
>
  <ToggleButton sx={{width:'50%',  }}  value="1">Yes</ToggleButton>
  <ToggleButton sx={{width:'50%',  }}   value="2">No</ToggleButton>
</ToggleButtonGroup>
</ThemeProvider>
