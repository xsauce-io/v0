...
const Wager: NextPage = () => {
  return (
      ...
      <main className="flex w-full flex-1 flex-col text-center">
       ...
       <h3 className='text-left pt-5 pb-3 text-md font-medium'>1.) Select Wager Direction</h3>
       <Wagerbtn />
       <h3 className='text-left pt-5 pb-2 text-md font-medium'>2.) Wager Amount</h3>
       <Wagerinput />
       </div>
      </main>
